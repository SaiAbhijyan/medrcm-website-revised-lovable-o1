      ...
      content: (
        <div className="space-y-4">
          ...
          <p className="text-rcm-gray-600">
            At MedRCM360, we take a comprehensive approach to revenue cycle management that addresses every aspect of your practice's financial health. Our methodology is built on four core principles:
          </p>
