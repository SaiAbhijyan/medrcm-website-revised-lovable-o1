...
const About = () => {
  ...
  const tabs = [{
    ...
    content: <div className="space-y-4">
          <h3 className="text-2xl font-display font-semibold mb-4">360° Revenue Cycle Management</h3>
          <p className="text-rcm-gray-600">At MedRCM, we take a comprehensive approach to revenue cycle management that addresses every aspect of your practice's financial health. Our methodology is built on four core principles:</p>
    ...
    title: "Our Story",
    content: <div className="space-y-4">
          <h3 className="text-2xl font-display font-semibold mb-4">Building Excellence Since 2008</h3>
          <p className="text-rcm-gray-600">
            MedRCM360 was founded by healthcare finance professionals who saw the challenges medical practices faced with increasingly complex billing requirements and shrinking reimbursements.
          </p>
          <div className="mt-6 space-y-4">
            <div className="flex">
              ...
              <div>
                <h4 className="text-lg font-medium text-rcm-gray-800 mb-1">Founded in Dallas, TX</h4>
                <p className="text-rcm-gray-600 text-sm">
                  MedRCM360 was established to provide specialized billing services to physician practices.
                </p>
              </div>
            </div>
            <div className="flex">
            ...
            <div className="flex">
              ...
              <div>
                ...
                <p className="text-rcm-gray-600 text-sm">
                  Now serving over 500 providers across 30 states with specialized RCM solutions.
                </p>
              </div>
            </div>
          </div>
    ...
    content: <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4 mt-6">
            ...
            <div className="bg-white p-4 rounded-lg shadow-soft">
              <div className="text-3xl font-bold text-[#0096D6] mb-1">15-20%</div>
    ...
    content: <div className="space-y-4">
          ...
          <p className="text-rcm-gray-600">
            At MedRCM360, our values shape everything we do - from how we interact with clients to how we develop our services.
          </p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className={`lg:col-span-5 transition-all duration-700 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-10'}`}>
            <div className="relative">
              ...
              <div className="relative rounded-xl overflow-hidden shadow-medium border border-rcm-gray-100">
                <img src="https://images.unsplash.com/photo-1557804506-669a67965ba0" alt="MedRCM360 team meeting about healthcare revenue cycle strategy" className="w-full h-auto object-cover" />
              </div>
          ...
          <div className={`lg:col-span-7 transition-all duration-700 delay-300 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-10'}`}>
            ...
            <p className="text-rcm-gray-600 text-lg mb-8">
              With over 15 years of experience, MedRCM360 has helped hundreds of healthcare providers across the country optimize their revenue cycles, reduce administrative burden, and increase profitability.
            </p>
            
            {/* Tabs */}
            <div className="mt-8">
              <div className="flex space-x-4 overflow-x-auto pb-2 mb-6">
                {tabs.map((tab, idx) => <button key={idx} onClick={() => setActiveTab(idx)} className={`flex items-center px-4 py-2 rounded-full transition-all whitespace-nowrap ${activeTab === idx ? 'bg-gradient-to-r from-[#006B5E] to-[#0096D6] text-white shadow-sm' : 'bg-rcm-gray-100 text-rcm-gray-700 hover:bg-rcm-gray-200'}`}>
